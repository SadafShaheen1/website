...
const Headertop = () => {
  return (
    <div className='bg-blue-50	border-b border-gray-200 sm:block'>
      <div className='container py-4'>
        <div className='flex justify-between items-center'>
          <div className='hidden lg:flex gap-4'>
            <div className=''>
              <a
                href="https://www.facebook.com/h2sbnb"
              ...
              >
                ...
                <span
                  className="absolute opacity-0 group-hover:opacity-100 group-hover:text-gray-700 group-hover:text-sm group-hover:-translate-y-8 duration-700"
                >
                  Facebook
                </span>
              </a>
            ...
            <div className='header_top_icon_wrapper'>
              <a
                href="https://www.instagram.com/h2sbnb"
                target="_blank" rel="noopener noreferrer"
                className="group flex justify-center p-2 rounded-md drop-shadow-xl from-gray-800 bg-[#f059b1] text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1em"
            ...
            <div className='header_top_icon_wrapper'>
              <a
                href="https://www.linkedin.com/h2sbnb"
                target="_blank" rel="noopener noreferrer"
          ...
          <div className='w-full flex justify-center'>
            <div className='text-center text-blue-700 text-[15px]'>
              <b>Find your perfect stay anywhere in the world with our easy-to-use vacation rental platform.</b>
            </div>
          </div>
        </div>
      </div>
